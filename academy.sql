...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2023 at 06:53 PM
...
(1, 20, 'I love this course', 3, 0),
(1, 21, 'Suitable for beginner', 5, 0),
...
(6, 41, 'Bad lecture', 1, 1),
(8, 25, NULL, NULL, 0),
(8, 26, 'Không hay', 2, 0),
(10, 26, 'Hay', 4, 0),
(11, 20, 'Not my interesting', 2, 0),
...
CREATE TABLE `user` (
  ...
  `Bio` text DEFAULT '',
  `CurrentJob` varchar(100) DEFAULT '',
  `Role` int(11) NOT NULL,
  `OTP` int(11) NOT NULL,
  `IDSocial` text DEFAULT '',
  `disable` int(1) NOT NULL DEFAULT 0
...
(41, 'Đại Dương', 'daiduong@gmail.com', '$2b$05$RqI16J4yIoN5rIyh37lMU.xlogoIg386dUU./Lu2hDT0vOZtIpbbK', '', '', 2, 0, '', 0),
(42, 'New instructor', 'brad@gmail.com', '$2b$05$cDIRDL1haBWQ9BJMHnB31OryWYzH4szyhcBDv8cnGZlYqzp1GDMyG', '', '', 1, 0, '', 0);
